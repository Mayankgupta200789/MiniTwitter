-- People
INSERT INTO people (id, handle,password, name)
VALUES
    (1, 'batman'  , '$2a$10$ltvB3JLllXgjpeM4KJfeieUXINa1xUplUmyMYgGFTN9l6A4BXo46S','Bruce Wayne'),
    (2, 'superman', '$2a$10$8gFWcFuLSEVncGNrjQgKKOY7l/YNC/iU7K8rsQ/Dvovt2iVZc3zrW' ,'Clark Kent'),
    (3, 'catwoman', '$2a$10$HTKg2icHuPPhG27B7nKNA.IBj4Tldc3YZgw1ZJ3eqDN30AqNTFBIK','Selina Kyle'),
    (4, 'daredevil','$2a$10$huW9w1uYIR1iOa1cM8f7YO4/.yeF/n/uC42yVQW93lQifD69fRUve', 'Matt Murdock'),
    (5, 'alfred','$2a$10$h9CSZKRZGYyW3gfcQER9NuAQpiZgy3GAaW8VO97tVJyo/rAtnhRda', 'Alfred Pennyworth'),
    (6, 'dococ','$2a$10$nkCbo.upbJFkrqoZHLECtO2rYhZW124mv4f3L1vyv5gsNxKRpeRN6' ,'Otto Octavius'),
    (7, 'zod','$2a$10$CMk/10hEEuEOV35Qyx1pO.qnteWOYiPL8ydVUtUpEenpJOkkLJZBm', 'Dru-Zod'),
    (8, 'spiderman','$2a$10$2FDpS6TI36TUH4jQ1.h4weFqfNulkHAP2wBFvFyIC5YnxtXxaWqV.', 'Peter Parker'),
    (9, 'ironman','$2a$10$FAVRn6LZMzNkaBPdkKihA.RURegBQUniuspciQ9hnY.ADLta7v9.m', 'Tony Stark'),
    (10, 'profx','$2a$10$t2tADouCCjHMzxjeGssQhOYw2TYaT32TsA1eb5rfeFGYKvCbugIUu', 'Charles Xavier'),
    (11, 'thor', '$2a$10$QEhgRgvUohyRIrt052Ta9eMEie54xa8JTHn3Z4QPeNwe.LseNfzva', 'Asgard');
